...
```{r}
plot(mygraph, edge.arrow.size=0, vertex.size=2, layout=layout.circle, main="circle")
```

```{r}
plot(mygraph, vertex.label="", edge.arrow.size=0, vertex.size=2, layout=layout.sphere, main="sphere")
```
