---
title: "Fiche espèce {{< meta params.sp_name >}} "
format:
  dashboard:
    scrolling: true
    nav-buttons:
...
# Répartition par rapport aux autres espèces
...
# Histogrammes sur les distances des jardins
...
for(i in 1:3) {
  ...
  # if (length(which(!(cat %in% df_histo[,1]))) ) {
  #   
  # }
